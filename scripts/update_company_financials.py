...
Output files:
- raw_conceptstock_company_income.csv (Type 34)
- raw_conceptstock_company_revenue.csv (Type 33)
"""
...
# Segment revenue CSV schema (Type 33)
REVENUE_FIELDNAMES = [
    "symbol",
    "company_name",
    "fiscal_year",
    ...
    try:
        ...
        for record in data:
            results.append({
                ...
                "operating_expenses": record.get("operating_expenses"),
                "research_and_development": record.get("research_and_development"),
                "selling_and_marketing": record.get("selling_and_marketing"),
                "general_and_administrative": record.get("general_and_administrative"),
                "amortization": record.get("amortization"),
                "operating_income": record.get("operating_income"),
                "other_income": record.get("other_income"),
                "income_before_tax": record.get("income_before_tax"),
                "tax": record.get("tax"),
